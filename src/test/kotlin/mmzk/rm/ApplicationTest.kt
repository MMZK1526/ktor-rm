...
class ApplicationTest {
    ...
    @Test
    fun canDecodeZero() = testDecode("0", null, listOf(), "ARRÊT", "")
    ...
    fun canDecodeAdder() = testDecode(
        ...
        "R76+ ",
        """
            L0: R1- 1 2
            L1: R0+ 0
            L2: R2- 3 4
    ...
    private fun testDecode(num: String, expectedPair: List<String>?, expectedList: List<String>, expectedLine: String, expectedRM: String) =
        testApplication {
            ...
            client.post("/decode") {
                ...
                assertEquals(data.decodeToLine, expectedLine)
